  ...
  return <div className="space-y-6">
      <div className="space-y-6">
        ...
        <div className="grid gap-4">
          <ProcessCourtSelector value={court} onChange={setCourt} disabled={isLoading} />

          <ProcessSearchInput value={processNumber} onChange={setProcessNumber} disabled={isLoading} />
      ...
      {!isLoading && <ProcessSearchResults results={searchResults} hasSearched={hasSearched} isLoading={isLoading} onSelectProcess={handleSelectProcess} onManual={!isPublic ? onManual : undefined} />}
    </div>;
}