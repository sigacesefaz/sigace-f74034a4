      ...
      <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          field
                ...
                <FormControl>
                  <InputMask component={Input} mask="0000000-00.0000.0.00.0000" placeholder="0000000-00.0000.0.00.0000" replacement={{
              _: /\d/
            }} value={field.value} onChange={e => field.onChange(e.target.value)} className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50" />
                </FormControl>
                <FormMessage />
              </FormItem>} />
          
          <FormField control={form.control} name="court" render={({
          field
        }) => <FormItem>
                ...
                <Select onValueChange={field.onChange} defaultValue={field.value}>
                  ...
                  <SelectContent>
                    {courts.ESTADUAL.map(court => <SelectItem key={court.id} value={court.name}>
                        {court.name}
                      </SelectItem>)}
                  </SelectContent>
                </Select>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <FormField control={form.control} name="instance" render={({
          field
        }) => <FormItem>
        ...
        field
              ...
              <FormControl>
                <Textarea placeholder="Descrição detalhada do processo" className="resize-none min-h-[100px]" {...field} />
              </FormControl>
              <FormMessage />
            </FormItem>} />

        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <FormField control={form.control} name="plaintiff" render={({
          field
        }) => <FormItem>
          ...
          <FormField control={form.control} name="plaintiff_document" render={({
          field
        }) => <FormItem>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <FormField control={form.control} name="defendant" render={({
          field
        }) => <FormItem>
          ...
          <FormField control={form.control} name="defendant_document" render={({
          field
        }) => <FormItem>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <FormField control={form.control} name="judge" render={({
          field
        }) => <FormItem>
          ...
          field
                ...
                <FormControl>
                  <Input type="number" placeholder="0.00" step="0.01" onChange={e => {
        ...
        <div className="flex justify-end gap-3 pt-4">
          <Button type="button" variant="outline" onClick={onCancel} disabled={isLoading} className="text-blue-800">
            Cancelar
          </Button>
