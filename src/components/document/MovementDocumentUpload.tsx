...
interface MovementDocumentUploadProps {
  processId: string;
  movementId: string;
  isOpen: boolean;
  onClose: () => void;
...
export function MovementDocumentUpload({ processId, movementId, isOpen, onClose, onSuccess }: MovementDocumentUploadProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={() => {
      ...
      <DialogContent className="sm:max-w-lg">
        <DialogHeader>
          <DialogTitle>Enviar Documento para o Evento</DialogTitle>
        </DialogHeader>
